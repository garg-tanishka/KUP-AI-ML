...
class LinkedList_WithRecursiveMethods extends AnyFlatSpec{
  ...
  val intLinkedList: LinkedList_WithRecursionMethods[Int] = linkedList_API.create(input1,input2,input3,input4,input5,input6)
  val doubleLinkedList: LinkedList_WithRecursionMethods[Double] = linkedList_API.create(input7,input8,input9)
  val stringLinkedList: LinkedList_WithRecursionMethods[String] = linkedList_API.create("Tanishka", "Swantika", "Priya")
  val charLinkedList: LinkedList_WithRecursionMethods[Char] = linkedList_API.create('T', 'a', 'n', 'i','s', 'h', 'k', 'a')
